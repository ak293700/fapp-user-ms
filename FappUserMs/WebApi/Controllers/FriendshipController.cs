...
public class FriendshipController : ControllerBase
{
    ...
    // [HttpGet("pending")]
    // public async Task<ActionResult<IEnumerable<LiteUserDto>>> GetUserPendingInvitations(CancellationToken cancellationToken = default)
    // {
    //     try
    //     {
    //         return Ok(await _friendshipService.GetUserPendingInvitations(_currentUserService.UserId, cancellationToken));
    //     }
    //     catch (NotFoundDomainException e)
    //     {
    //         return NotFound(e.Message);
